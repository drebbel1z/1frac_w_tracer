...
frac_aperature = 3.0604501441e-04
...
endTime = 432000#864000 # 10 days.  This is about 6 days after injection which seems fine
initial_dt = 100
dt_max = 10000
...
tracer_start_time = 333401 # this is one day after 10 bpm is reached
...
# USE THIS [PorousFlowFullySaturated] FOR TH ONLY
# tracer_type = "none"
...
!include injection_tracer_pp.i
!include production_tracer_pp.i
!include injection_tracer_diracs.i
[PorousFlowFullySaturated]
  coupling_type = ThermoHydro
  porepressure = porepressure
  temperature = temperature
...
[Mesh]
  ...
  [fmg]
    ...
    file = '1frac_Fractures_Local_${mesh_size}m_marked.e'
  []
[]
